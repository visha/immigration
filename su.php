...
$result = mysql_query("SELECT Title,FirstName,LastName,score,comments,eligibility FROM userdetails where username='$user'");
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <table cellspacing=1 cols=3 cellpadding=1 width=597 align="center" bgcolor="#AAAFB5">

    <tr  bgcolor=#6890A3 align="left" valign="top">
     
		 <td colspan=2 background="images/step_bg.gif" height="24"><font size="2" face="verdana,Arial, Helvetica, sans-serif"><b><font color="#FFFFFF">Client Information:-<a name="Step1"></a></font></b></font><font size="3" face="verdana,Arial, Helvetica, sans-serif" color="#FFFFFF"><b></b></font></td>  		

    </tr>
</table>		


<table width="597"  style="border: 1px solid black;" border="0" cellspacing="1" cellpadding="1" align="center">
