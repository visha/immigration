...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Investor Program</span></h2>
          <div class="clr"></div>
          
          <img src="images/img_1.jpg" width="613" height="179" alt="image" />
          <div class="clr"></div>
          <h2>Investor Program</h2><div class="clr"></div>
          <p><strong>Every year, thousands of international business people come to Canada to do business with Canadian companies. There are requirements you must meet to be allowed into Canada. Global Enterprises can help you avoid problems that can affect your business plans.</strong></p>
		  
          <p>Please get in touch with the office of Global Enterprises so that you can be provided proper guidance from following categories:</p>
          <p>Global Enterprises can provide you correct guidance on the following:</p>
		    <ul>
		  <li> Study Permit</li>
		  <li>Before you apply</li>
		  <li>Who can apply and</li>
		  <li>Whether you are eligible for any Study permit or not</li>
		  </ul>	
