 ...
 <div class="header">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Corporate Immigration</span></h2>
          <div class="clr"></div>
          
          <img src="images/img_1.jpg" width="613" height="179" alt="image" />
          <div class="clr"></div>
          <h2><span>Corporate Immigration</span></h2><div class="clr"></div>
         <p> Hart Kaminker, Barrister & Solicitor, is able to assist companies of all sizes, small, medium and large corporations, with their corporate immigration requirements.  We understand that in today’s globalized economy it is necessary to get personnel across borders quickly and efficiently.</p>

<p>Hart A. Kaminker’s office provides his corporate clients personal attention, guiding his clients through the process of moving their personnel across borders from the beginning of the process to the end. </p>

<p>These services include assisting with obtaining a Labour Market Opinion (LMO) if required and advice on documentation required to support a work permit application to ensure that the transfer of your personnel is done smoothly and efficiently.</p>
