...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Arranged Employment</span></h2>
          <div class="clr"></div>
          
          <img src="images/img_1.jpg" width="613" height="179" alt="image" />
          <div class="clr"></div>
          <h2>Arrange Employement</h2><div class="clr"></div>
          <p><strong>Global Enterprises offers Arranged Employment consultancy services to aspirants wish to migrate to Canada. This service is provided in accordance with the guidance from Mr. Hart A. Kaminker, Barrister and Solicitor.</strong></p>
          <p>Global Enterprises is closely associated with the law office of Hart A. Kaminker  in Toronto, Ontario, Canada which does all the background checks, preliminary scrutiny and liaison work with other local authorities to ensure our clients settle down to a new life in Canada, with minimum fuss and maximum joy.</p>
          <p>To know more details about immigration to Canada under Arranged Employment, please get in touch with us.</p>
