 ...
 <div class="header">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Hart Kaminker</span></h2>
          <div class="clr"></div>
          
          <img src="images/indexbanner.jpg" width="613" height="179" alt="image" />
          <div class="clr"></div>
          <p> Hart Kaminker, Barrister & Solicitor, is a law firm dedicated to
providing personal, professional and efficient services relating to
Canada's immigration laws. The firm provides services in all areas
of immigration including consular processing of permanent and temporary visas and representation before Canada's Federal Court and all immigration tribunals. These services are provided by Hart A. Kaminker and his dedicated staff.

The firm keeps up to date with all developments affecting Canada's immigration laws and strives to find solutions to client's issues.
The firm can also address a client's needs beyond immigration including issues relating to business and real estate concerns.

Please browse through this site to find more information about who we are, what we do and how to immigrate to Canada.
</p>
